      ...
      lang: {
        zh: {
          ...
          content: '<p>\n' +
            ...
            '\n' +
            '      <h3>1.适用范围</h3>\n' +
            '      <p>在您使用本软件服务时，本软件将在得到您许可的情况下使用或记录的您手机上的硬件与信息，包括但不限于：设备型号、系统版本、ANDROID ID、SN、MAC、IMEI、本地存储等；</p>\n' +
            '\n' +
            '      <h3>2.信息的使用</h3>\n' +
            ...
            '        <li>本地存储：软件生成的应用数据(加密)会以文件的形式保存在本地；</li>\n' +
            '      </ol>\n' +
            '\n' +
            '      <h3>3.信息披露</h3>\n' +
            ...
            '        <li>官网地址：<a href="'+config.un.site+'" target="_blank">'+config.un.site+'</a></li>\n' +
            '      </ul>'
        },
        en: {
          ...
          content: '<p>\n' +
            ...
            '\n' +
            '      <h3>1.Scope</h3>\n' +
            '      <p>When you use the Software Service, the software will use or record the hardware and information on your mobile phone with your permission, including but not limited to: device model, system version, ANDROID ID, SN, MAC, IMEI, local storage, etc.</p>\n' +
            '\n' +
            '      <h3>2.Usage</h3>\n' +
            ...
            '        <li>Local storage: Software generated application data (encrypted) will be saved in the form of files in the local;</li>\n' +
            '      </ol>\n' +
            '\n' +
            '      <h3>3.Disclosure</h3>\n' +
            ...
            '        <li>Website：<a href="'+config.un.site+'" target="_blank">'+config.un.site+'</a></li>\n' +
            '      </ul>'
        }
      }
    },
