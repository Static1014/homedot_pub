      ...
      lang: {
        zh: {
          ...
          content: '<p>\n' +
            ...
            '\n' +
            '      <h3>1.适用范围</h3>\n' +
            '      <p>在您使用本软件服务时，本软件将在得到您许可的情况下使用或记录的您手机上的硬件与信息，包括但不限于：设备型号、系统版本、ANDROID ID、相机、相册、本地存储等；</p>\n' +
            '\n' +
            '      <h3>2.信息的使用</h3>\n' +
            '      <p>在获得您的数据之后，本软件会将必要信息上传至服务器，以留作业务办理凭证，如设备型号、系统版本号、ANDROID ID等。非必要信息不会上传，本地使用完成后即删除。具体使用如下：</p>\n' +
            '      <ol>\n' +
            '        <li>设备型号、系统版本、ANDROID ID：在关于中进行展示，以便用户反馈问题时进行问题定位与查询；</li>\n' +
        ...
        en: {
          ...
          content: '<p>\n' +
            ...
            '\n' +
            '      <h3>1.Scope</h3>\n' +
            '      <p>When you use the Software Service, the software will use or record the hardware and information on your mobile phone with your permission, including but not limited to: device model, system version, ANDROID ID, camera, photo album, local storage, etc.</p>\n' +
            '\n' +
            '      <h3>2.Usage</h3>\n' +
